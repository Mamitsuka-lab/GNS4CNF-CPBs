...
def parse_serialized_simulation_example(example_proto, metadata):
  ...
  print("L context: ", context)
  print("L Featuer: ", parsed_features)
  print("Parsed features position shape: ", parsed_features['position'].shape)
  print("Parsed features context shape: ", parsed_features['step_context'].shape)
